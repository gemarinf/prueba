<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pageAdministrador.aspx.cs" Inherits="pageAdministrador" %>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; height: 30px">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:clientesConnectionString %>" SelectCommand="SELECT [identificacion] FROM [Administrador]"></asp:SqlDataSource>
